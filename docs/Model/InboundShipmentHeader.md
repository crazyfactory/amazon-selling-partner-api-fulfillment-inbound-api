...
**shipment_status** | [**\CrazyFactory\Spapi\Client\Model\ShipmentStatus**](ShipmentStatus.md) |  | 
**label_prep_preference** | [**\CrazyFactory\Spapi\Client\Model\LabelPrepPreference**](LabelPrepPreference.md) | The preference for label preparation for an inbound shipment. | 
**intended_box_contents_source** | [**\CrazyFactory\Spapi\Client\Model\IntendedBoxContentsSource**](IntendedBoxContentsSource.md) |  | [optional] 
