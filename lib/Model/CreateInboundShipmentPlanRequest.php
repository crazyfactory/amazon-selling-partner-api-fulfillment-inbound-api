...
class CreateInboundShipmentPlanRequest implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \CrazyFactory\SpapiClient\Model\Address $ship_from_address The address from which the inbound shipment will be sent.
     *
     * @return $this
     */
     ...
     *
     * @param \CrazyFactory\SpapiClient\Model\LabelPrepPreference $label_prep_preference The seller's preference for label preparation for an inbound shipment.
     *
     * @return $this
     */
     ...
     *
     * @return \CrazyFactory\SpapiClient\Model\InboundShipmentPlanRequestItemList
     */
     ...
     *
     * @param \CrazyFactory\SpapiClient\Model\InboundShipmentPlanRequestItemList $inbound_shipment_plan_request_items inbound_shipment_plan_request_items
     *
     * @return $this
     */
